...
exports.default = _vue2.default.extend({
    ...
    methods: {
        ...
        addRow: function addRow() {
            this.points.push(new _Point2.default(0, 0));
        },
        ...
        clear: function clear() {
            this.points = [new _Point2.default(0, 0), new _Point2.default(0, 0), new _Point2.default(0, 0)];
        },
...
},{"../Point":2,"vue":39}],5:[function(require,module,exports){
"use strict";
...
exports.default = _vue2.default.extend({
    ...
    mounted: function mounted() {
        ...
        canvas.onclick = function (e) {
            return _this.isPointInPolygone(e);
        };
        this.$store.dispatch("initGraphic", canvas);
    },
    methods: {
        isPointInPolygone: function isPointInPolygone(e) {
            var drawMode = this.$store.getters.drawMode;
            if (drawMode !== _DrawMode.DrawMode.SELECT_POINT_MODE) {
                return;
            }
...
},{"../DrawMode":1,"../Point":2,"vue":39}],6:[function(require,module,exports){
"use strict";
...
},{"../DrawMode":1,"vue":39}],7:[function(require,module,exports){
"use strict";
...
},{"../components/AddPolygonFrom":4,"../components/PaintBox":5,"../components/PaintBoxToolbar":6,"vue":39}],8:[function(require,module,exports){
"use strict";
...
},{"./layout":7,"./store":9,"vue":39,"vuex":41}],9:[function(require,module,exports){
"use strict";
...
var store = new _vuex2.default.Store({
    ...
    actions: {
        ...
        createPolygon: function createPolygon(_a, points) {
            var state = _a.state,
                commit = _a.commit;
            state.points = (0, _tslib.__spreadArrays)(points);
            state.graphic.clear();
            state.graphic.strokePolygon(state.points);
        },
        clearPoints: function clearPoints(_a) {
            var state = _a.state,
                commit = _a.commit;
            state.points = [];
        },
        isPointInPolygone: function isPointInPolygone(_a, point) {
            var state = _a.state,
                commit = _a.commit;
            _axios2.default.post("api/Graphic/IsPointInPolygone", {
...
},{"../DrawMode":1,"../Point":2,"../tools/Graphic":11,"axios":12,"tslib":37,"vue":39,"vuex":41}],10:[function(require,module,exports){
"use strict";
...
var Graphic = /** @class */function () {
    ...
    Graphic.prototype.drawPolygon = function (points) {
        ...
        ctx.strokeStyle = _Colors2.default.ForegroundColor;
...
},{"../Point":2,"../Viewport":3,"./Colors":10}],12:[function(require,module,exports){
...
},{"./adapters/http":13,"./adapters/xhr":13,"./helpers/normalizeHeaderName":32,"./utils":35,"_process":42}],26:[function(require,module,exports){
'use strict';
...
},{"timers":43}],39:[function(require,module,exports){
(function (process){
...
},{"./vue.common.dev.js":38,"./vue.common.prod.js":40,"_process":42}],40:[function(require,module,exports){
(function (global,setImmediate){
/*!
 * Vue.js v2.6.12
 * (c) 2014-2020 Evan You
...
},{"process/browser.js":42,"timers":43}]},{},[8])
